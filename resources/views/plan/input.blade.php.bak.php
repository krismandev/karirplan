                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="" class="form-control" maxlength="15" placeholder="Contoh: 2018/2019-Genap" id="namaSemester">
                            </td>
                        </tr>
                        <tr>
                            <td>
            ...
            <div class="table-box">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td></td>
                            <td>1. Apakah semester ini Anda mengikuti pendidikan formal dan memperoleh gelar Doktor/sederajat?</td>
                            <td>
                                <select class="selectize" id="A-I-A-1-a">
                        ...
                        <tr>
                            <td></td>
                            <td>2. Apakah semester ini Anda mengikuti pendidikan formal dan memperoleh gelar Magister/sederajat?</td>
                            <td>
                                <select class="selectize" id="A-I-A-1-b">
                                    <option value="1">Ya</option>
                                    <option value="0" selected>Tidak</option>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="selectize" id="A-I-A-2">
                                    <option value="1">Ya</option>
                                    <option value="0" selected>Tidak</option>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="A-II-A" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                        ...
                        <tr>
                            <td></td>
                            <td>2. Apakah Anda ikut berperan dalam pelaksanaan pendidikan untuk pendidikan dokter klinis?</td>
                            <td>
                                <select class="selectize" onchange="onOffQue(this.value,'A-II-A-3')">
                                    <option value="1">Ya</option>
                                    <option value="0" selected>Tidak</option>
                                </select>
                            </td>
                        ...
                        <tr>
                            <td></td>
                            <td class="subASK">a. Berapa SKS Anda melakukan pengajaran untuk peserta pendidikan dokter melalui tindakan medik spesialistik?</td>
                            <td>
                                <div class="input-group">
                                    <input type="text" id="A-II-A-3-a" class="form-control A-II-A-3" value="0" onkeypress="return validasi_number(event)" maxlength="3" disabled="disabled">
                                    <span class="input-group-addon btn-default">SKS</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td></td>
                            <td class="subASK">b. Berapa SKS Anda melakukan pengajaran konsultasi spesialis kepada peserta pendidikan dokter?</td>
                            <td>
                                <div class="input-group">
                                    <input type="text" id="A-II-A-3-b" class="form-control A-II-A-3" value="0" onkeypress="return validasi_number(event)" maxlength="3" disabled="disabled">
                                    <span class="input-group-addon btn-default">SKS</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td></td>
                            <td class="subASK">c. Berapa SK Anda melakukan pemeriksaan luar dengan pembimbingan terhadap peserta pendidikan dokter?</td>
                            <td>
                                <div class="input-group">
                                    <input type="text" id="A-II-A-3-c" class="form-control A-II-A-3" value="0" onkeypress="return validasi_number(event)" maxlength="3" disabled="disabled">
                                    <span class="input-group-addon btn-default">SKS</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td></td>
                            <td class="subASK">d. Berapa SKS Anda melakukan pemeriksaan dalam dengan pembimbingan terhadap peserta pendidikan dokter?</td>
                            <td>
                                <div class="input-group">
                                    <input type="text" id="A-II-A-3-d" class="form-control A-II-A-3" value="0" onkeypress="return validasi_number(event)" maxlength="3" disabled="disabled">
                                    <span class="input-group-addon btn-default">SKS</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td></td>
                            <td class="subASK">e. Berapa SKS Anda menjadi saksi ahli dengan pembimbingan terhadap peserta pendidikan dokter?</td>
                            <td>
                                <div class="input-group">
                                    <input type="text" id="A-II-A-3-e" class="form-control A-II-A-3" value="0" onkeypress="return validasi_number(event)" maxlength="3" disabled="disabled">
                                    <span class="input-group-addon btn-default">SKS</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="selectize" id="A-II-B">
                                    <option value="1">Ya</option>
                                    <option value="0" selected>Tidak</option>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="selectize" id="A-II-C">
                                    <option value="1">Ya</option>
                                    <option value="0" selected>Tidak</option>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="selectize" onchange="onOffQue(this.value,'A-II-D-1')">
                                    <option value="1">Ya</option>
                                    <option value="0" selected>Tidak</option>
                                </select>
                            </td>
                        ...
                        <tr>
                            <td></td>
                            <td class="subASK">d. Berapakah jumlah lulusan mahasiswa D-III yang akan Anda bimbing?</td>
                            <td>
                                <div class="input-group">
                                    <input type="text" id="A-II-D-1-d" class="form-control A-II-D-1" value="0" onkeypress="return validasi_number(event)" maxlength="3" disabled="disabled">
                                    <span class="input-group-addon btn-default">Lulusan</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td></td>
                            <td>2. Apakah pada semester ini Anda akan menjadi pembimbing pendamping?</td>
                            <td>
                                <select class="selectize" onchange="onOffQue(this.value,'A-II-D-2')">
                                    <option value="1">Ya</option>
                                    <option value="0" selected>Tidak</option>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="A-II-D-2-b" class="form-control A-II-D-2" value="0" onkeypress="return validasi_number(event)" maxlength="3" disabled="disabled">
                                    <span class="input-group-addon btn-default">Lulusan</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="A-II-D-2-c" class="form-control A-II-D-2" value="0" onkeypress="return validasi_number(event)" maxlength="3" disabled="disabled">
                                    <span class="input-group-addon btn-default">Lulusan</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="A-II-D-2-d" class="form-control A-II-D-2" value="0" onkeypress="return validasi_number(event)" maxlength="3" disabled="disabled">
                                    <span class="input-group-addon btn-default">Lulusan</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="A-II-E-1" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Lulusan</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="A-II-E-2" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Lulusan</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td></td>
                            <td>Berapa jumlah kegaitan mahasiswa yang Anda bina pada semester ini?</td>
                            <td>
                                <div class="input-group">
                                    <input type="text" id="A-II-F" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="A-II-G" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="A-II-H-1" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="A-II-H-2" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="A-II-I-1" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <select class="selectize" id="A-II-J">
                                    ...
                                    <option value="4">Ketua Sekolah Tinggi/Pembantu Dekan</option>
                                    ...
                                    <option value="3">Pembantu Direktur Akademik/Ketua Jurusan/Ketua Prodi pada Universitas/Politeknik/Akademi, Sekretaris Jurusan/bagian pada Universitas/Institut/Sekolah Tinggi</option>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="A-II-K-1" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="A-II-K-2" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Orang</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="A-II-L-1" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Orang</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <select class="selectize" id="A-II-M">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-A-1-a-2" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Buku</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-A-1-a-1" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-A-1-a-2-1" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Buku</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-A-1-a-2-2" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-A-1-b-1-1" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-A-1-b-1-2" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-A-1-b-1-3" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td></td>
                            <td>8. Pada semseter ini, berapakah hasil penelitian atau pemikiran Anda yang dipublikasikan dalam jurnal nasional terakreditasi?</td>
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-A-1-b-2" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td></td>
                            <td>9. Pada semester ini, berapakah hasil penelitian atau pemikiran Anda yang dibupublikasikan dalam jurnal nasional berbahasa Indonesia dan terindeks pada DOAJ?</td>
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-A-1-b-2-1" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td></td>
                            <td>10. Pada semester ini, berapakah hasil penelitian atau pemikiran Anda yang dibupublikasikan dalam jurnal nasional berbahasa Inggris atau bahasa resmi (PBB) dan terindeks pada DOAJ?</td>
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-A-1-b-2-2" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-A-1-b-3" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-A-1-b-3-1" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr class="bold uppercase">
                            <td class="parentJudul">2</td>
                            <td colspan="3">Hasil penelitian atau hasil pemikiran yang didesiminasikan</td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>1. Pada semester ini, berapakah hasil penelitian/pemikiran Anda yang didesiminasikan dan dipresentasikan secara oral dan dimuat dalam prosiding yang dipublilkasikan (ber ISSN/ISBN) secara internasional?</td>
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-A-1-c-1-a-1" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td></td>
                            <td>2. Pada semester ini, berapakah hasil penelitian/pemikiran Anda yang didesiminasikan dan dipresentasikan secara oral dan dimuat dalam prosiding yang dipublilkasikan (ber ISSN/ISBN) secara nasional?</td>
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-A-1-c-1-b-1" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td></td>
                            <td>3. Pada semester ini, berapakah hasil penelitian/pemikiran Anda yang didesiminasikan dan dimuat dalam prosiding yang dipublikasikan secara internasional?</td>
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-A-1-c-2-a" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td></td>
                            <td>4. Pada semester ini, berapakah hasil penelitian/pemikiran Anda yang didesiminasikan dan dimuat dalam prosiding yang dipublikasikan secara nasional?</td>
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-A-1-c-2-b" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td></td>
                            <td>5. Pada semester ini, berapakah hasil penelitian/ pemikiran Anda yang disajikan dalam seminar/simposium/lokakarya tetapi tidak dimuat dalam prosiding secara internasional?</td>
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-A-1-c-1-a" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td></td>
                            <td>6. Pada semester ini, berapakah hasil penelitian/ pemikiran Anda yang disajikan dalam seminar/simposium/lokakarya tetapi tidak dimuat dalam prosiding secara nasional?</td>
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-A-1-c-1-b" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td></td>
                            <td>7. Pada semester ini, berapakah hasil penelitian/ pemikiran Anda yang tidak disajikan dalam seminar/simposium/lokakarya, tetapi dimuat dalam prosiding secara internasional?</td>
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-A-1-c-3-a" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td></td>
                            <td>8. Pada semester ini, berapakah hasil penelitian/ pemikiran Anda yang tidak disajikan dalam seminar/simposium/lokakarya, tetapi dimuat dalam prosiding secara nasional?</td>
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-A-1-c-3-b" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td></td>
                            <td>9. Pada semester ini, berapakah hasil penelitian/pemikiran Anda yang disajikan dalam koran/majalah populer atau umum?</td>
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-A-1-d" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-A-2" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-B" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-C" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-D-1" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-D-2" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-E-1" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-E-2" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-E-3" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="B-II-E-4" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Karya</span>
                                </div>
                            </td>
                            <td>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="C-II" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="C-III-1-a" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Program</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="C-III-1-b" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Program</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="C-III-1-c" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Program</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="C-III-2-a" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Program</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="C-III-2-b" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Program</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="C-III-2-c" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Program</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="C-III-2-d" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Program</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="C-IV-a" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Program</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="C-IV-b" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Program</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="C-IV-c" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Program</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="C-V" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default">Program</span>
                                </div>
                            </td>
                            <td>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="selectize" id="D-I-a">
                                    <option value="1">Ya</option>
                                    <option value="0" selected>Tidak</option>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="selectize" id="D-I-b">
                                    <option value="1">Ya</option>
                                    <option value="0" selected>Tidak</option>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="D-II-a-1" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="D-II-a-2" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlength="3">
                                    <span class="input-group-addon btn-default" title="Kepanitiaan">Kepanitia..</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="D-II-b-1" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlengh="3">
                                    <span class="input-group-addon btn-default" title="Kepanitiaan">Kepanitia..</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="D-II-b-2" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlengh="3">
                                    <span class="input-group-addon btn-default" title="Kepanitiaan">Kepanitia..</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="selectize" id="D-III-a-1">
                                    <option value="1">Ya</option>
                                    <option value="0" selected>Tidak</option>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="selectize" id="D-III-a-2">
                                    <option value="1">Ya</option>
                                    <option value="0" selected>Tidak</option>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="selectize" id="D-III-a-3">
                                    <option value="1">Ya</option>
                                    <option value="0" selected>Tidak</option>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="selectize" id="D-III-b-1">
                                    <option value="1">Ya</option>
                                    <option value="0" selected>Tidak</option>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="selectize" id="D-III-b-2">
                                    <option value="1">Ya</option>
                                    <option value="0" selected>Tidak</option>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="selectize" id="D-III-b-3">
                                    <option value="1">Ya</option>
                                    <option value="0" selected>Tidak</option>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="D-IV" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlengh="3">
                                    <span class="input-group-addon btn-default" title="Kepanitiaan">Kepanitia..</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="D-V-a" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlengh="3">
                                    <span class="input-group-addon btn-default">Kegiatan</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="D-V-b" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlengh="3">
                                    <span class="input-group-addon btn-default">Kegiatan</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="selectize" id="D-VI-a">
                                    <option value="1">Ya</option>
                                    <option value="0" selected>Tidak</option>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="selectize" id="D-VI-b">
                                    <option value="1">Ya</option>
                                    <option value="0" selected>Tidak</option>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="D-VII-a-1" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlengh="3">
                                    <span class="input-group-addon btn-default">Kegiatan</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="D-VII-a-2" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlengh="3">
                                    <span class="input-group-addon btn-default">Kegiatan</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="D-VII-b-1" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlengh="3">
                                    <span class="input-group-addon btn-default">Kegiatan</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="D-VII-b-2" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlengh="3">
                                    <span class="input-group-addon btn-default">Kegiatan</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="selectize" id="D-VIII-a">
                                    <option value="1">Ya</option>
                                    <option value="0" selected>Tidak</option>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="selectize" id="D-VIII-b">
                                    <option value="1">Ya</option>
                                    <option value="0" selected>Tidak</option>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="selectize" id="D-VIII-c">
                                    <option value="1">Ya</option>
                                    <option value="0" selected>Tidak</option>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="D-VIII-d" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlengh="3">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="D-VIII-e" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlengh="3">
                                    <span class="input-group-addon btn-default">T. Jasa</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="D-VIII-f" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlengh="3">
                                    <span class="input-group-addon btn-default">T. Jasa</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="D-IX-a" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlengh="3">
                                    <span class="input-group-addon btn-default">Buku</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="D-IX-b" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlengh="3">
                                    <span class="input-group-addon btn-default">Buku</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="D-IX-c" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlengh="3">
                                    <span class="input-group-addon btn-default">Buku</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="D-X-a" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlengh="3">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="D-X-b" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlengh="3">
                                    <span class="input-group-addon btn-default" title="Medali/Piagam">Medali/...</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" id="D-X-c" class="form-control" value="0" onkeypress="return validasi_number(event)" maxlengh="3">
                                    <span class="input-group-addon btn-default" title="Medali/Piagam">Medali/...</span>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="selectize" id="D-XI">
                                    <option value="1">Ya</option>
                                    <option value="0" selected>Tidak</option>
                                </select>
                            </td>
...
<div class="col-xs-12 right">
    <button class="btn btn-md btn-success" onclick="update()">Simpan Perencanaan</button>
</div>
